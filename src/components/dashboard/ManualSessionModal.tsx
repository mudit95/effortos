...
export function ManualSessionModal() {
  const showManualSession = useStore(s => s.showManualSession);
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-semibold text-white">Log Manual Session</h3>
              </div>
              <button
                onClick={() => { setShowManualSession(false); setNotes(''); }}
            ...
            <p className="text-sm text-white/40 mb-4">
              Forgot to start the timer? Log a 25-minute session retroactively.
            </p>
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="flex-1"
                onClick={() => {
                  addManualSession(notes.trim() || undefined);
                  setNotes('');
                }}
              >
                Log Session
